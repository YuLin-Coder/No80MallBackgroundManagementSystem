    ...
    <div class="layui-form-item" >
       <div class="layui-inline">
           ...
           <div class="layui-input-block">
               <input type="text" class="layui-input" name="code"  autocomplete="off" lay-verify="required" maxlength="50"  placeholder="请输入编码">
           </div>
       </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="name"  autocomplete="off" lay-verify="required" maxlength="50"  placeholder="请输入名称">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    layui.config({
        ...
        form.on("submit(saveCommonCode)",function(data){
            ...
            $.ajax({
                url : '${ctx}/commonCode/ajax_save_commonCode.do',
                type : 'post',
                async: false,
                data : {
